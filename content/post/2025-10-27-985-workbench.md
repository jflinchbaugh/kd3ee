...
- {{<qrz NA3CW>}}, Chuck:
  ...
  - {{<qrz W3KZG>}}, Scott:
    - For {{<qrz NA3CW>}}, Chuck: SECRA doesn't accept that stuff,
...
- {{<qrz KD3EE>}}, John: Seeing a 20kHz-wide band of noise in the 30M band.
...
- {{<qrz AA3LH>}}, Leon:
  ...
  - {{<qrz W3KZG>}}, Scott:
    - {{<qrz KB3ZIM>}}, Bob, may have some trains to re-home.
